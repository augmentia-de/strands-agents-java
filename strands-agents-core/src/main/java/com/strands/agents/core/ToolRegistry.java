...
import com.strands.agents.core.tools.BashTool;
import com.strands.agents.core.tools.EditTool;
import com.strands.agents.core.tools.FindTool;
import com.strands.agents.core.tools.GrepTool;
import com.strands.agents.core.tools.LsTool;
import com.strands.agents.core.tools.ReadTool;
import com.strands.agents.core.tools.TextContent;
import com.strands.agents.core.tools.WebFetchTool;
import com.strands.agents.core.tools.WebSearchTool;
import com.strands.agents.core.tools.WriteTool;
...
public class ToolRegistry {
    ...
    public void register(com.strands.agents.core.tools.AgentTool<?> agentTool) {
        var spec = toToolSpecification(agentTool);
        tools.put(agentTool.name(), new AgentToolMethod(agentTool, spec));
    }

    private static ToolSpecification toToolSpecification(com.strands.agents.core.tools.AgentTool<?> tool) {
    ...
    record AgentToolMethod(com.strands.agents.core.tools.AgentTool<?> agentTool, ToolSpecification spec) implements ToolMethod {
        ...
        public String execute(String jsonArguments) throws Exception {
            ...
            com.strands.agents.core.tools.AgentTool raw = agentTool;
    ...
    public static class Builder {
        private final List<com.strands.agents.core.tools.AgentTool<?>> agentTools = new ArrayList<>();
        ...
        public Builder with(com.strands.agents.core.tools.AgentTool<?> tool) {
            agentTools.add(tool);
            return this;
        }
