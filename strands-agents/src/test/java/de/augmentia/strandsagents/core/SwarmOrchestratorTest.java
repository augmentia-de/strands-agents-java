...
class SwarmOrchestratorTest {
    ...
    void shouldRouteToMatchingAgentByKeyword() {
        var weatherAgent = new Agent(new MockChatModel("Wetter-Antwort: %s"));
        var mathAgent = new Agent(new MockChatModel("Mathe-Antwort: %s"));
    ...
    void shouldRouteBasedOnListOfRoutes() {
        var weatherAgent = new Agent(new MockChatModel("W: %s"));
        var mathAgent = new Agent(new MockChatModel("M: %s"));
        var defaultAgent = new Agent(new MockChatModel("D: %s"));
