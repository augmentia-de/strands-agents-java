...
import com.strands.agents.core.MockChatModel;
...
class TelemetryTest {
    ...
    void hookRegistryShouldFilterEvents() {
        ...
        registry.onEvent(new ToolExecutionStartedEvent("s1", Instant.now(),
            new com.strands.agents.core.model.tool.ToolCall("id1", "tool", "{}")));
    ...
    void loggingHookShouldAcceptAllEventTypes() {
        ...
        var toolCall = new com.strands.agents.core.model.tool.ToolCall("id1", "test-tool", "{}");
        var toolResult = new com.strands.agents.core.model.tool.ToolExecutionResult("id1", "test-tool", "ok", false);
        // should not throw
