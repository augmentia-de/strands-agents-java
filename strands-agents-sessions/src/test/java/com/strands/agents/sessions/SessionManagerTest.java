...
import com.strands.agents.core.SessionManager;
import com.strands.agents.core.model.agent.AgentState;
import com.strands.agents.core.model.agent.AgentStatus;
...
class SessionManagerTest {
    ...
    void agentWithFileSessionManagerPersistsConversation(@TempDir Path tempDir) {
        ...
        var agent = new com.strands.agents.core.StrandsAgent(
            new com.strands.agents.core.MockChatModel(),
            new com.strands.agents.core.ToolRegistry(),
            new com.strands.agents.core.ToolExecutor(),
            null,
            sessionManager
        );
    ...
    void agentWithoutSessionManagerStillWorks() {
        ...
        assertThat(result.stopReason())
            .isEqualTo(com.strands.agents.core.model.agent.StopReason.COMPLETED);
    }
